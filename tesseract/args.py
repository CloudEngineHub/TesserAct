...
def _get_training_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--load_pretrained_lora", action="store_true", help="Whether to load pretrained LoRA weights.")
    parser.add_argument("--load_pretrained_model_path", type=str, default=None, help="Load the model.")
    parser.add_argument("--keyframe_only", action="store_true", default=False, help="Use key frame only.")
    parser.add_argument("--validation_only", action="store_true", default=False, help="Use key frame only.")
    parser.add_argument("--action_lora", action="store_true", default=False, help="Use key frame only.")

...
VALIDATION_PROMPT="\"fold the cloth from bottom left to top right Trossen WidowX 250 robot arm:::"\
  ...
  for lr_schedule in "${LR_SCHEDULES[@]}"; do
    for optimizer in "${OPTIMIZERS[@]}"; do
      for steps in "${MAX_TRAIN_STEPS[@]}"; do
        output_dir="./runs/models/tesseract-depth-normal-lora-bridge__framelength_${frame_length}__optimizer_${optimizer}__lr-schedule_${lr_schedule}__learning-rate_${learning_rate}/"
